...
public class AttachmentUserApiTest : ApiMappingBaseTest
{
    ...
    public async Task HandleUploadForEntityAndOwner_NewSucceeds()
    {
        ...
        attachmentRepositoryMock
            .Setup(r => r.SingeByEntityOwnerAndFileNameAsync(expectedTenantId, expectedEntity, expectedOwnerId,
                expectedFileName))
            .ReturnsAsync(null as Data.Public.Attachment);
        ...
        attachmentRepositoryMock
            ...
            .Callback((Guid tenantId, Guid? userId, string identifier, IDictionary<string, object> claims, Data.Public.Attachment attachment) =>
            {
                Assert.Multiple(() =>
                {
